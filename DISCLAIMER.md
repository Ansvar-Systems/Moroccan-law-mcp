# Legal Disclaimer / Avertissement juridique / إخلاء المسؤولية القانونية

**READ THIS CAREFULLY BEFORE USING THIS SOFTWARE**
**LISEZ ATTENTIVEMENT AVANT D'UTILISER CE LOGICIEL**
...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (relation avocat-client)
...
### For Legal Professionals / Pour les professionnels du droit
...
- **Professional Rules**: Members of the Association des Barreaux du Maroc and the Ordre des Avocats must comply with applicable professional conduct rules when using AI tools
- **Client Disclosure**: Consider whether professional ethics rules require disclosing AI tool use to clients

### Duty of Independent Verification / Devoir de vérification indépendante
...
1. Checking the official source (Bulletin Officiel du Royaume du Maroc at sgg.gov.ma and the Adala Justice portal)
2. Verifying the provision is currently in force and has not been amended
3. Reading the full context of cited provisions in both Arabic and French official texts
4. Consulting case law and preparatory works (travaux préparatoires) for interpretation
...
This Tool aggregates data from official Moroccan legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **Official government databases** | Authoritative | Statute text (primary reference) |
| **Bulletin Officiel** | Authoritative | Official gazette, promulgated laws |
| **Community/open-data sources** | Supplementary | Case law, cross-references (verify independently) |
| **International treaty databases** | Authoritative for international law | International obligations metadata |

**CRITICAL**: Community-maintained resources are **NOT** official government publications. While generally reliable, they may contain transcription errors, outdated information, or incomplete coverage. Moroccan law is published officially in both **Arabic** and **French**; discrepancies between language versions should be resolved by consulting the Arabic original.

### Commercial Legal Databases

For professional legal work, **always cross-check with commercial legal databases** such as:

- Artemis (Lexis MA), Juris Maroc, Mahkamaty
...
- Moroccan law changes continuously through new dahirs, decrees, statutes, and court decisions
...
- Even "fresh" data may be outdated if recent amendments were published in the Bulletin Officiel
...
3. **Legal commentary** -- No editorial annotations, academic commentary (doctrine), or practice guides
4. **Unpublished decisions** -- Lower court decisions and administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of preparatory works and parliamentary debates
6. **Customary and Islamic law sources** -- Traditional Maliki jurisprudence and customary practices that may apply in certain matters are not included
7. **Bilingual reconciliation** -- No systematic comparison between Arabic and French official texts
...
- **International Law Blind Spots**: Cannot fully assess international treaty obligations or Francophone legal community standards
...
- Produce inaccurate translations or transliterations of Arabic legal terms
...
2. **Official Verification**: Cross-check ALL results with official sources (Bulletin Officiel at sgg.gov.ma, Adala Justice portal)
3. **Commercial Databases**: Use professional legal databases for authoritative, annotated versions
4. **Bilingual Check**: Verify both Arabic and French official texts where applicable
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Moroccan-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Moroccan-law-mcp/issues
...
## Summary: What You Must Do / Résumé
