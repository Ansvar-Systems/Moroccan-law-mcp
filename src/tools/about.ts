...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Moroccan Law MCP',
    version: context.version,
    jurisdiction: 'MA',
    description: 'Moroccan Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Secretariat General du Gouvernement',
        url: 'https://www.sgg.gov.ma',
        authority: 'Secretariat General du Gouvernement',
      },
    ],
    freshness: {
